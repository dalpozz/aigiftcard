...
st.set_page_config(page_title="AI GIFT CARD", page_icon="⭐", layout="centered", initial_sidebar_state="collapsed")

st.title("AI GIFT CARD ⭐")
st.subheader("Upload Your photo and create an amazing gift card for your loved ones!")
...
if image is not None:
    ...
    prompt="Gift card, Voucher, character design, 8k resolution, 3D render, high resolution, 4k, hyperrealistic",
